...
<?php 
	...
	$csCero = $conCero -> query("SELECT p1_R1a, p2_R1a, p3_R1a, p4_R1a, p5_R1a, p6_R1a, p7_R1a, p8_R1a,  p9_R1a, p10_R1a, p11_R1a, p12_R1a, p13_R1a, p14_R1a, p15_R1a, p16_R1a,  p17_R1a, p18_R1a, p19_R1a, p20_R1a, p21_R1a, empresa_R1a, dirEmpresa_R1a,  correo_R1a, codeMd5_R1a, usrSexo_R1a, usrNumEmp_R1a, fechaHoraInicio_R1a,  fechaHoraFinal_R1a, usrNombre_R1a,gpsd  FROM dataEmpleadosDos  INNER JOIN nom035R1a ON Nombred = usrNombre_R1a  WHERE  usrNombre_R1a = 'ALCANTARA VAZQUEZ JOSE JAVIER' OR usrNombre_R1a = 'ALCANTARA VAZQUEZ JOSE JAVIER' OR usrNombre_R1a = 'ANDRADE AUSTRIA ROCIO' OR usrNombre_R1a = 'ARAUJO JIMENEZ JOSE MIGUEL' OR usrNombre_R1a = 'ARELLANO SANCHEZ ARMANDO' OR usrNombre_R1a = 'BUTRON CAMACHO AXEL ALFREDO' OR usrNombre_R1a = 'CARRAZCO VALENCIA CARLOS' OR usrNombre_R1a = 'CARRILLO BALCAZAR BARTOLO ROSENDO' OR usrNombre_R1a = 'CASTRO ESPINDOLA JOSE EDGAR' OR usrNombre_R1a = 'CRUZ OLVERA JUAN' OR usrNombre_R1a = 'DELGADO GUILLEN LUIS ALBERTO' OR usrNombre_R1a = 'ESCOBAR HERNANDEZ JUAN ARTURO' OR usrNombre_R1a = 'ESPARZA GUERRERO EFREN' OR usrNombre_R1a = 'FUENTES VILLANUEVA DAVID EDGAR' OR usrNombre_R1a = 'GOMEZ TOVAR JAIR ANTONIO' OR usrNombre_R1a = 'GONZALEZ ARELLANO ISMAEL' OR usrNombre_R1a = 'GONZALEZ HERNANDEZ JORGE ERIK' OR usrNombre_R1a = 'HERNANDEZ CORNELIS LUIS RODRIGO' OR usrNombre_R1a = 'HERNANDEZ MARTINEZ DIEGO ARMANDO' OR usrNombre_R1a = 'HUERTA LOPEZ HECTOR' OR usrNombre_R1a = 'LOPEZ ANACLETO FERNANDO' OR usrNombre_R1a = 'LOPEZ BUENDIA YOSAFAT JACOBO' OR usrNombre_R1a = 'LOPEZ VELASCO ERIC OSMAR' OR usrNombre_R1a = 'MACHORRO MELENDEZ JUAN ANTONIO' OR usrNombre_R1a = 'MATEOS NERI JESUS' OR usrNombre_R1a = 'MELITON RAMIREZ ELIDE ITZEL' OR usrNombre_R1a = 'MORALES PALOMARES CARLOS ALBERTO' OR usrNombre_R1a = 'OLVERA MONTOYA JORGE' OR usrNombre_R1a = 'ORTIZ BAZ EZEQUIEL' OR usrNombre_R1a = 'PEREZ ALVAREZ JULIO CESAR' OR usrNombre_R1a = 'RAMIREZ ABURTO HILDA FABIOLA' OR usrNombre_R1a = 'ROBLES ZARATE SOFIA ALEJANDRA' OR usrNombre_R1a = 'RODRIGUEZ CERVANTES SERGIO' OR usrNombre_R1a = 'ROSALES NAVA JESUS EVANIBALDO' OR usrNombre_R1a = 'RUIZ RODRIGUEZ MARIA DE JESUS' OR usrNombre_R1a = 'SANCHEZ SOTO IRVIN OSVALDO' OR usrNombre_R1a = 'SOLANO ROSAS DANIEL' OR usrNombre_R1a = 'SOLIS GONZALEZ ALBERTO' OR usrNombre_R1a = 'TEXCOCANO XOCHIHUILA ARMANDO' OR usrNombre_R1a = 'VALADEZ UGALDE MILDRED' OR usrNombre_R1a = 'VAZQUEZ HERNANDEZ LUIS MIGUEL' OR usrNombre_R1a = 'VIURQUEZ RIOS JUAN PABLO' ORDER BY usrNombre_R1a;");
